...
doc.moveDown();
  ...
  doc.fontSize(14).font('Helvetica').text('A titulo de exemplo verifica-se que o art. 202, I do CTB, com base na observância do MBFT, prevê os campos “Quando Autuar e Quando não Autuar”, fazendo ainda menção a outra tipificação com conduta semelhante (Art. 193 CTB), motivo pelo qual complementação das informações é necessária.', { align: 'left' });
  doc.moveDown();
